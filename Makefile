all: hyph_la_classical.dic hyph_la_modern.dic hyph_la_liturgical.dic
...
clean:
	rm patterns/hyph_la_classical.dic patterns/hyph_la_modern.dic patterns/hyph_la_liturgical.dic
