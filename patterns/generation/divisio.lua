...
function classicalHyphenation(word)
	...
	for _, code in utf8.codes(word) do
		...
		-- read "ngu"; vowel may follow and lead to a nonsyllabic u
	...
	if state == "potential diphthong" or state == "vowel"
		or state == "potential ng" or state == "potential rh"
		or state == "potential aspirate" or state == "potential muta cum liquida"
